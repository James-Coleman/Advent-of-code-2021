...
let exampleCucumbers = OceanFloor(exampleInput)

let exampleLine = "...>>>>>..."

var exampleLineCucumbers = OceanFloor(exampleLine)
exampleLineCucumbers.step()
//exampleLineCucumbers.debugPrint() // "...>>>>.>.." (correct)
...
var example2Cucumbers = OceanFloor(example2)
example2Cucumbers.step()
//example2Cucumbers.debugPrint() // correct
...
var example3Cucumbers = OceanFloor(example3)
example3Cucumbers.step()
example3Cucumbers.step()
example3Cucumbers.step()
example3Cucumbers.step()
//example3Cucumbers.debugPrint() // correct
...
var example4Cucumbers = OceanFloor(example4)
//example4Cucumbers.settle() // 58 (correct)
//example4Cucumbers.debugPrint() // correct
